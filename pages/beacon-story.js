...
export default function BeaconStory() {
  ...
  return (
    <div className={`${poppins.variable} ${inter.variable} ${styles.root}`}>
      <Head>
        <title>Why I Built Beacon | Beacon</title>
        <meta name="description" content="The anonymous personal story behind Beacon, an app created to help people understand their drinking habits, track progress and regain control." />
